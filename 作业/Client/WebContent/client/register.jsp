 ...
 <%@include file="head.jsp" %>
  ...
  <%@include file="menu_search.jsp" %>
	...
	<div id="divcontent" align="center">
		<form action="${pageContext.request.contextPath}/client/registersuccess.html" method="post" onsubmit="return checkForm();">
					...
					<td style="padding: 30px"><h1>新会员注册 </h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td colspan="2">&nbsp;&nbsp;
                                <input type="radio" name="gender" value="ç·" checked="checked" /> 男
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="gender" value="å¥³" />  女
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
